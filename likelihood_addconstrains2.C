...
void fcn(Int_t& npar, Double_t* gin, Double_t& f, Double_t *par, Int_t iflag){
  ...
  if ( y>0&& pdf>0){
    ...
    temp=y*(log(par[2]*insidelog))-par[2]*insidelog+log(constrain(par));
    double noconstrain=y*(log(par[2]*insidelog))-par[2]*insidelog;
...
void likelihood_addconstrains2(){
