...
void  LikelihoodSterile_modified6(int ifile){
  //output histograms
...
ifstream spectrum_file;
 ...
 TH1F *hpileuppar=new TH1F("hpileuppar","pile up par",200,0.5,1.5);
  ...
  TH1F *hqerror=new TH1F("hqerror","Q Error",100,1.0E-7,0.06E-2);
  ...
  TFile *fout=new TFile(Form("/home/fatemigh/projects/rpp-jillings/fatemigh/sterile/Likelihood/fitresultsrootpileup/fitresultswithpileuptheta%i.root",ifile),"recreate");
